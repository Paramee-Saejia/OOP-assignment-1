...
# Test 1: Add Books
print("\n--- TEST 1: Adding Books ---")
library.add_book(Book(1, "Python Crash Course", "Eric Matthes", 3, 3))
library.add_book(Book(2, "Clean Code", "Robert Martin", 2, 2))
library.add_book(Book(3, "The Pragmatic Programmer", "Hunt & Thomas", 1, 1))
library.add_book(Book(4, "Design Patterns", "Gang of Four", 2, 2))
